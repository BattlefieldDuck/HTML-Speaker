...
null)};synth.speak(c);activeSpeaker=a}else synth.paused?(a.textContent=a.textContent.replace(b,d),synth.resume()):synthspeaking&&(a.textContent=a.textContent.replace(d,b),synth.pause())})});